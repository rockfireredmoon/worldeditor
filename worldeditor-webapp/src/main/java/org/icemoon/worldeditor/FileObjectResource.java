...
public class FileObjectResource extends AbstractResource {
	...
	public FileObjectResource(final String contentType) {
		this(contentType, null, null);
	}

	public FileObjectResource(final String contentType, FileObject file) {
		this(contentType, file, null);
	}

	public FileObjectResource(final String contentType, FileObject file, final String filename) {
	...
	protected ResourceResponse newResourceResponse(final Attributes attributes) {
		...
		try {
			if (!file.exists()) {
				...
				response.setContentLength(file.getContent().getSize());
